package com.lightsoft.practica_ra.model
...
class MainActivityModel : ViewModel(){
    ...
    val anioFinanciamiento : State<Int> = _añoFinanciamiento
    ...
    fun asignarFinanciamiento(año:Int,porcentjeFinanciamiento:Double){
        _añoFinanciamiento.value = año
